...
public class RandomCasing extends PasswordDecorator{
    ...
    //Setting this to will allow us to have a 50% of a upper or lowercase letter because Random will return a 0 or 1. If it were changed to 3 there would be a 33% chance etc.
